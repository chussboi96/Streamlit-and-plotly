...
# # Basic Page Configurations to to make GUI
st.set_page_config(page_title="My visualization of Video-Game Sales Data",
                   page_icon=":bar_chart:",
                   layout="wide")
st.markdown(""" <style>
...
# Header
st.header("Dashboard by Hammad Javaid ")
st.sidebar.write( "Use these sliders to change height & width of the plots")
...
st.subheader("Sales data by Year")
op1 = st.multiselect(
    "Select Sales Category", ["NA_Sales", "EU_Sales", "Other_Sales", "Global_Sales"], default="Global_Sales")
...
left.subheader("Sales Data by Region")
lst = []
...
right.subheader("Sales data by genre")
plt.figure(3)
...
st.sidebar.write("DASHBOARD by Hammad javaid i21-1661")
